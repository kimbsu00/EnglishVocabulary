...
class TestMeaningActivity : AppCompatActivity() {
    ...
    fun setProblem(index: Int) {
        ...
        binding.apply {
            ...
            problemWord.text = problem.answer.eng

            answer1.text = map.get(1)?.kor
            answer2.text = map.get(2)?.kor
            answer3.text = map.get(3)?.kor
            answer4.text = map.get(4)?.kor
            answer5.text = map.get(5)?.kor
        }
    }
